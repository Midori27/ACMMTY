...
public class Error{
    ...
    public static final String EMAIL = "formato inválido";
    public static final String RANGO_FECHA_NACIMIENTO = "Debe de estar entre: ";
    public static final String FORMATO_MATRICULA = "Debe de tener el formato A0XXXXXXX";
}
