...
public class Usuario {
    ...
    @NotNull(message="ConfirmaPassword: "+Error.EN_BLANCO)
    @NotBlank(message="ConfirmaPassword: "+Error.EN_BLANCO)
    @EqualToField(message="ConfirmaPassword: El valor no concuerda con password.",value=Usuario.COL_PASSWORD)
    ...
    public Usuario(String nombreUsuario, String password, String confirmaPassword, String nombre, String apellidoP, String apellidoM, String email, int tipo) {
        this.nombreUsuario = nombreUsuario;
        this.password = password;
