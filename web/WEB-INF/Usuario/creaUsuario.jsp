...
<body>
	...
	<div class="container">
        ...
        <form action="CreaUsuario" method="post">
            <label>Nombre</label><input class="textbox" type="text" name="nombre"  id="nombre" value="<%=usuario.getNombre()%>"/><br /><br />
            <label>Apellido Paterno</label><input class="textbox" type="text" name="apellidoP"  id="apellidoP" value="<%=usuario.getApellidoP()%>"/>
            <br />
            <label>Apellido Materno</label><input class="textbox" type="text" name="apellidoM"  id="apellidoM" value="<%=usuario.getApellidoM()%>"/>
            <br />
            <!--
            <label>Fecha de Nacimiento</label>
            <input type="date" class="textbox" name="fechaNacimiento" id="fechaNacimiento" value="aaaa-mm-dd"><br /><br /><br />
            <label>Telefono</label><input class="textbox" type="text" name="telefono"  id="telefono" value="<%=usuario.getTelefono()%>"/><br /><br />
