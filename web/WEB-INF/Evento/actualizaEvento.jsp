				...
				<form action="ActualizaEvento"  method="post" enctype="multipart/form-data">
                	<fieldset class="info_fieldset">
						...
						<div id="fields">
			                ...
			                <input type="text" name="nombre" value=" <%=evento.getNombre()%> "/> 
			                <br>
			                <br>
			                <label for="fecha">Fecha del Evento</label>
			                <input type="text" name="fecha" value="<%=evento.getFechaString()%>">
			                <br>
			                <br>
			                <label>Lugar</label><input type="text" name="lugar" value="<%=evento.getLugar()%>"/>
			                <br>
			                <br>
