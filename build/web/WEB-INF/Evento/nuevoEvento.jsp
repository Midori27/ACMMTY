...
<body>
	...
	<div class="container">
		...
		<div id="contentInside">
			...
			<!-- forma de envio -->
			<div id="form">
			<form id="form" action="evento" onsubmit="return validateEvento(this)" method="post">
					<fieldset class="info_fieldset">
						<div id="note"></div>
						<div id="fields">
							<label>Nombre Evento</label><input class="textbox" type="text" name="nombre"  id="nombre"/><br />
							<label>Fecha del Evento</label>
							<input type="date" class="textbox" name="fechaNacimiento" id="fecha" value="mm-dd-aaaa"><br /><br />
							<label>Lugar</label><input class="textbox"  type="text" name="lugar"  id="lugar"/><br />
							<label>Descripción del Evento</label><input class="textbox"  type="text" name="descripcion"  id="descripcion"/>
							<br /><br />
							<label>Integrantes por Equipo</label><input class="textbox"  type="text" name="integrantesPorEquipo"  id="integrantesPorEquipo"/>
